	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2 style="color:red;"> Goto Website</h2></a>
				</div>
				...
				<div class="box-login">
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									...
									<i class="fa fa-lock"></i>
									 </span><br><br><a href="forgot-password.php">Forgot Password ?	</a>
							</div>
					...
					<div class="copyright">
						</span><span class="text-bold text-uppercase">Smart Clinic Automation</span>.
					</div>
