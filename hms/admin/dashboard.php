								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Online Booking </h2>
...
{
?>
											Total :<?php echo htmlentities($num_rows);  } ?>		
												</a>
											</p>
										</div>
									</div>
...
{
?>
											Total  :<?php echo htmlentities($num_rows1);  } ?>		
												</a>
...
{
?>
											Total :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
...
?>
											Total  :<?php echo htmlentities($num_rows22);   ?>	
												</a>
												</a>
											</p>
										</div>
